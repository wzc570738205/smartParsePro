...
const wx_getToken = () => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: 'https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx81c25ab0c9954698&secret=434e283eda618d92618229ccac9fecaf',
      method: 'POST',
...
wx_getToken().then(token => {
  wx_getaddress(token).then((res) => {
    addressList = res;
